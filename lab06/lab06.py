...
class Account:
    ...
    def deposit(self, amount):
        ...
        self.transactions.append(Transaction(index, self.balance, self.balance + amount))
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions.append(Transaction(index, self.balance, self.balance))
            return 'Insufficient funds'
        self.balance = self.balance - amount
        self.transactions.append(Transaction(index, self.balance + amount, self.balance))
        return self.balance
