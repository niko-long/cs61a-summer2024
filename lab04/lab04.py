def divide(quotients, divisors):
    ...
    """
    return {m:[n for n in divisors if n % m == 0] for m in quotients}
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    city_compare = make_city('city_compare', lat, lon)
    dist_a = distance(city_a, city_compare)
    dist_b = distance(city_b, city_compare)
    if dist_a < dist_b:
